...
interface HelperTestRunnerCreateInterface extends ethers.utils.Interface {
  functions: {
...
export class HelperTestRunnerCreate extends Contract {
  ...
  interface: HelperTestRunnerCreateInterface;
