...
interface IOvmFraudVerifierInterface extends ethers.utils.Interface {
  functions: {
...
export class IOvmFraudVerifier extends Contract {
  ...
  interface: IOvmFraudVerifierInterface;
