...
import { IOvmStateManager } from "./IOvmStateManager";

export class IOvmStateManagerFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IOvmStateManager {
    return new Contract(address, _abi, signerOrProvider) as IOvmStateManager;
  }
}
