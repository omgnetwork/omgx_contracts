...
import { IOvmFraudVerifier } from "./IOvmFraudVerifier";

export class IOvmFraudVerifierFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IOvmFraudVerifier {
    return new Contract(address, _abi, signerOrProvider) as IOvmFraudVerifier;
  }
}
