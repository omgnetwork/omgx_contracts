...
interface MockOvmBondManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockOvmBondManager extends Contract {
  ...
  interface: MockOvmBondManagerInterface;
