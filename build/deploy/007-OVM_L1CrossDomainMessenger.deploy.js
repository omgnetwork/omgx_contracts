...
const deployFn = async (hre) => {
    ...
    const OVM_L1CrossDomainMessenger = await hardhat_deploy_ethers_1.getDeployedContract(hre, 'OVM_L1CrossDomainMessenger', {
        signerOrProvider: deployer,
    });
    ...
    await Lib_AddressManager.setAddress('OVM_L1CrossDomainMessenger', result.address);
};
